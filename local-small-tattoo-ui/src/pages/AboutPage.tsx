import { AboutArtistSection } from "../features/about/components/AboutArtistSection";
...
export function AboutPage() {
  ...
  return (
    <main className="about-page">
      ...
      {data.artistSection.isVisible !== false ? (
        <AboutArtistSection content={data.artistSection} />
      ) : null}
