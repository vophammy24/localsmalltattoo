    ...
    <>
      <form className="booking-form" onSubmit={submitForm} noValidate aria-busy={isSubmitting}>
        ...
        <div className="booking-form__grid">
          ...
          <fieldset className="booking-field booking-field--full booking-schedule">
            ...
            <div className="booking-schedule__periods">
              {BOOKING_TIME_OPTIONS.map((option) => {
                const isSelected =
                  values.preferredTimePeriods.includes(option.value);
            ...
            {errors.preferredTimePeriods ? (
              <p
                className="booking-field__error"
                id="preferredTimePeriods-error"
              >
                {errors.preferredTimePeriods}
              </p>
            ) : null}
            ...
            <p className="booking-schedule__note">
              Select every period that works for you. The final appointment
              will be confirmed by phone.
            </p>
          </fieldset>
          ...
          <div className="booking-field booking-field--full">
            <label
              className={`booking-consent ${errors.consent ? "has-error" : ""}`}
            >
              <input
                type="checkbox"
                name="consent"
              ...
              <p>
                ...
                to be contacted by phone or email regarding this booking
